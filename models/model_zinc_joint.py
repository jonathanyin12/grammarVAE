...
class MoleculeVAE():
    ...
    def create(self,
        ...
        self.autoencoder.compile(optimizer='Adam',
                                 loss={'decoded_mean': vae_loss, 'property_loss': vae_loss},
                                 metrics=['accuracy'])
    ...
    def _buildEncoder(self, x, latent_rep_size, max_length, epsilon_std=0.01):
        ...
        def vae_loss(true, pred_decoded_mean):
            ...
            if K.int_shape(pred_decoded_mean)[1] == max_length:
                ...
                print(true.shape, pred_decoded_mean.shape)
    ...
    def _buildDecoder(self, z, latent_rep_size, max_length, charset_length):
        ...
        print('build decoder', K.int_shape(h), K.int_shape(hp))
