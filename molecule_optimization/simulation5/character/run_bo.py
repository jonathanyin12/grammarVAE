...
while iteration < 5:
    ...
    logP_values = np.loadtxt('../../latent_features_and_targets_character/logP_values.txt')
    SA_scores = np.loadtxt('../../latent_features_and_targets_character/SA_scores.txt')
    cycle_scores = np.loadtxt('../../latent_features_and_targets_character/cycle_scores.txt')
